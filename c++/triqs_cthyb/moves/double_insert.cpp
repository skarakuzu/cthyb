...
namespace triqs_cthyb {
  ...
  move_insert_c_c_cdag_cdag::move_insert_c_c_cdag_cdag(int block_index1, int block_index2, int block_size1, int block_size2, std::string const &block_name1, std::string const &block_name2, qmc_data &data, wl_data& data_wl, bool yes_worm, mc_tools::random_generator &rng, histo_map_t *histos)
     : data(data),
       data_wl(data_wl),
       yes_worm(yes_worm),
       config(data.config),
